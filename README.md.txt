...
Алгоритм RL_optimal_stopping_problem в данном репозитории реализован неверно, так как вероятность правильного выбора превышает пороговое значения теоретическое в 37%
